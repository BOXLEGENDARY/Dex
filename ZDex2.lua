...
local function main()
    ...
    local window, codeFrame, consoleFrame
    local currentView = "Code" -- "Code" or "Console"
    ...
    Notepad.Init = function()
        ...
        local function switchView(view)
            currentView = view
            if view == "Code" then
                codeFrame.Frame.Visible = true
                consoleFrame.Visible = false
            elseif view == "Console" then
                codeFrame.Frame.Visible = false
        ...
        execute.Size = UDim2.new(0.20, 0, 0, 20)
        ...
        clear.Size = UDim2.new(0.20, 0, 0, 20)
        clear.Text = "Clear"
        ...
        copy.Size = UDim2.new(0.20, 0, 0, 20)
        copy.Text = "Copy to Clipboard"
        copy.TextColor3 = Color3.new(1, 1, 1)
        ...
        save.Size = UDim2.new(0.20, 0, 0, 20)
        save.Text = "Save to File"
        save.TextColor3 = Color3.new(1, 1, 1)
        ...
        local home = Instance.new("TextButton", window.GuiElems.Content)
        home.BackgroundTransparency = 1
        home.Position = UDim2.new(1, -220, 0, 0)  -- ย้ายไปขวาสุด -220 px
        home.Size = UDim2.new(0.20, 0, 0, 20)
        home.Text = "Home"
        ...
        local consoleBtn = Instance.new("TextButton", window.GuiElems.Content)
        consoleBtn.BackgroundTransparency = 1
        consoleBtn.Position = UDim2.new(1, -110, 0, 0)  -- ย้ายไปขวาสุด -110 px
        consoleBtn.Size = UDim2.new(0.20, 0, 0, 20)
        ...
        consoleBtn.MouseButton1Click:Connect(function()
            ...
            for _, log in ipairs(logs) do
                ...
                textLabel.Text = os.date("[%H:%M:%S] ", log.timestamp) .. log.message
                textLabel.TextColor3 = Color3.new(1, 1, 1)
                textLabel.TextXAlignment = Enum.TextXAlignment.Left
                textLabel.BackgroundTransparency = 1
                textLabel.Size = UDim2.new(1, -10, 0, 20)
                textLabel.Position = UDim2.new(0, 5, 0, y)
                textLabel.Parent = consoleFrame
                y = y + 20
            end

            consoleFrame.CanvasSize = UDim2.new(0, 0, 0, y)
        end)

        switchView("Code")

        codeFrame:SetText("-- editor")
    end
...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
		    ...
		    {13,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Version",Parent={2},Position=UDim2.new(1,-110,1,-35),Size=UDim2.new(0,105,0,20),Text=Main.Version,TextColor3=Color3.new(0.6, 0.7, 0.8),TextSize=14,TextXAlignment=1,}},
