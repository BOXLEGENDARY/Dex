...
local Explorer, Properties, ScriptViewer, Script, ModelViewer, Console, Notebook -- Major Apps
...
-- Main vars
local Main, Explorer, Properties, ScriptViewer, Script, ModelViewer, Console, DefaultSettings, Notebook, Serializer, Lib
local API, RM
...
Main = (function()
	...
	Main.ModuleList = {"Explorer","Properties","ScriptViewer","Script","ModelViewer","Console"}
	Main.Elevated = false
	Main.MissingEnv = {}
