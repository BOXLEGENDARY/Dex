...
-- Main vars
local Main, Explorer, Properties, ScriptViewer, Notepad, ModelViewer, Console, RemoteSpy, DefaultSettings, Notebook, Serializer, Lib
local API, RM
...
Main = (function()
	...
	Main.CreateMainGui = function()
		...
		Main.CreateApp({Name = "Model Viewer", IconMap = Main.LargeIcons, Icon = "Watcher", Window = ModelViewer.Window})
