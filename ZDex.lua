...
local Explorer, Properties, ScriptViewer, Notepad, ModelViewer, Console, ZSpy, Notebook
...
-- Main vars
local Main, Explorer, Properties, ScriptViewer, Notepad, ModelViewer, Console, ZSpy, DefaultSettings, Notebook, Serializer, Lib
local API, RM
...
Main = (function()
	...
	Main.ModuleList = {"Explorer","Properties","ScriptViewer","Notepad","ModelViewer","Console","ZSpy"}
	Main.Elevated = false
	Main.MissingEnv = {}
	...
	Main.LoadSettings = function()
		...
		if s and data and data ~= "" then
			...
			if s and decoded then
			    ...
			    warn("[ZDex] Failed to load settings")
			end
		else
			Main.ResetSettings()
		end
	...
	Main.FetchRMD = function()
		...
		if Main.Elevated then
			...
			rawXML = rawXML or game:HttpGet("https://raw.githubusercontent.com/BOXLEGENDARY/Roblox-Client-Tracker/refs/heads/main/ReflectionMetadata.xml")
		else
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
            ...
            {2,"Frame",{Active=true,BackgroundColor3=Color3.new(0.12,0.12,0.12),BorderSizePixel=0,Name="Main",Parent={1},Position=UDim2.new(0.5,-175,0.5,-100),Size=UDim2.new(0,350,0,200),}},
            {3,"Frame",{BackgroundColor3=Color3.new(0.15,0.0,0.35),BorderSizePixel=0,ClipsDescendants=true,Name="Holder",Parent={2},Size=UDim2.new(1,0,1,0),}},
            ...
            {5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="ZDex",TextColor3=Color3.new(0.8,0.2,1.0),TextSize=50,TextTransparency=1,}},
            {6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="Debug Suite",TextColor3=Color3.new(0.5,0.5,0.6),TextSize=18,TextTransparency=1,}},
            {7,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="StatusText",Parent={3},Position=UDim2.new(0,20,0,110),Size=UDim2.new(0,180,0,25),Text="Fetching API",TextColor3=Color3.new(1.0,0.3,0.6),TextSize=14,TextTransparency=1,}},
            {8,"Frame",{BackgroundColor3=Color3.new(0.07,0.07,0.07),BorderSizePixel=0,Name="ProgressBar",Parent={3},Position=UDim2.new(0,110,0,145),Size=UDim2.new(0,0,0,4),}},
            {9,"Frame",{BackgroundColor3=Color3.new(120/255, 0, 255/255),BorderSizePixel=0,Name="Bar",Parent={8},Size=UDim2.new(0,0,1,0),}},
            {10,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://2764171053",ImageColor3=Color3.new(0.15,0.0,0.35),Parent={8},ScaleType=1,Size=UDim2.new(1,0,1,0),SliceCenter=Rect.new(2,2,254,254),}},
            {11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by ZxL",TextColor3=Color3.new(0.7,0.7,0.7),TextSize=14,TextXAlignment=1,}},
            {12,"UIGradient",{Parent={11},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
            {13,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Version",Parent={2},Position=UDim2.new(1,-110,1,-35),Size=UDim2.new(0,105,0,20),Text=Main.Version,TextColor3=Color3.new(0.7,0.7,0.7),TextSize=14,TextXAlignment=1,}},
	...
	Main.CreateMainGui = function()
		...
		Main.CreateApp({Name = "ZSpy", IconMap = Main.LargeIcons, Icon = "Watcher", Window = ZSpy.Window})
