...
local function main()
	...
	Explorer.ShowRightClick = function(MousePos)
		...
		if presentClasses["LuaSourceContainer"] then
			...
			context:AddRegistered("DISASSEMBLE_SCRIPT", not presentClasses.isViableDecompileScript)
...
return search]==]
	...
	Explorer.Init = function()
		...
		local searchSize = (Settings.Explorer.AutoUpdateMode >= 1) and UDim2.new(1, -26, 0, 18) or UDim2.new(1, -6, 0, 18)
		...
		local explorerItems = create({
			...
			{3,"Frame",{BackgroundColor3=Color3.new(0.14901961386204,0.14901961386204,0.14901961386204),BorderColor3=Color3.new(0.1176470592618,0.1176470592618,0.1176470592618),BorderSizePixel=0,Name="SearchFrame",Parent={2},Position=UDim2.new(0,3,0,1),Size=searchSize,}},
        ...
        if Settings.Explorer.AutoUpdateMode >= 1 then
